  ...
  return (
    <View className="gap-[7px]">
      ...
      <View
        ...
        style={{ borderWidth: 1, borderColor: focused ? C.inkFaint : C.lineStrong }}>
        ...
        <TextInput
          ...
          {...rest}
        />
        {suffix ? <Txt className="text-[13px] text-ink-faint">{suffix}</Txt> : null}
      </View>
          ...
          <Pressable
            ...
            {on ? (
              <View
                ...
                style={{ borderWidth: 1.5, borderColor: C.ink, backgroundColor: 'rgba(237,237,237,0.09)' }}
              />
            ) : null}
